        ...
        async function initScanEffect() {
            try {
                ...
                const assets = await PIXI.Assets.load([
                    "img/Cueva_Guerrero.jpeg",
                    "img/Cueva_Guerrero_Dark.png"
                ]);
                const colorTexture = assets["img/Cueva_Guerrero.jpeg"];
                const depthTexture = assets["img/Cueva_Guerrero_Dark.png"];
